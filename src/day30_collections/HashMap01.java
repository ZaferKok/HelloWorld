...
public class HashMap01 {
	...
	public static void main(String[] args) {
		...
		// No compile time error, no run time error for same keys.
		hashMap.put(1, "X");
		...
		hashMap.remove(11); // returns true or false, key 11 is not exist remove()
							// can not remove anything  and returns false
		System.out.println(hashMap); // {1=X, 2=B, 3=C, 5=E, 6=X}
		hashMap.remove(6, "X");
		System.out.println(hashMap); // {1=X, 2=B, 3=C, 5=E}
